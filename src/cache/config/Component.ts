...
export default class Component {
    ...
    static decode(dat: Packet) {
        ...
        while (dat.available > 0) {
            ...
            if (com.comType === Component.TYPE_LAYER) {
                com.scroll = dat.g2();
                com.hide = dat.gbool();
            ...
            if (com.comType === Component.TYPE_UNUSED) {
                dat.pos += 3;
            }

            if (com.comType === Component.TYPE_INVENTORY) {
                ...
                for (let i = 0; i < 5; i++) {
                    const op = dat.gjstr();
                    com.iop[i] = op.length > 0 ? op : null;
                }
            }

            if (com.comType === Component.TYPE_RECT) {
                com.fill = dat.gbool();
            }

            if (com.comType === Component.TYPE_TEXT || com.comType === Component.TYPE_UNUSED) {
                com.center = dat.gbool();
                com.font = dat.g1();
                com.shadowed = dat.gbool();
            }

            if (com.comType === Component.TYPE_TEXT) {
                com.text = dat.gjstr();
                com.activeText = dat.gjstr();
            }

            if (com.comType === Component.TYPE_TOOLTIP) {
                com.text = dat.gjstr();
            }

            if (com.comType === Component.TYPE_UNUSED || com.comType === Component.TYPE_RECT || com.comType === Component.TYPE_TEXT) {
                com.colour = dat.g4s();
            }

            if (com.comType === Component.TYPE_RECT || com.comType === Component.TYPE_TEXT) {
                com.activeColour = dat.g4s();
                com.overColour = dat.g4s();
                com.activeOverColour = dat.g4s();
            }

            if (com.comType === Component.TYPE_SPRITE) {
                com.graphic = dat.gjstr();
                com.activeGraphic = dat.gjstr();
            }

            if (com.comType === Component.TYPE_MODEL) {
                com.model = dat.g1();
                if (com.model != 0) {
            ...
            if (com.comType === Component.TYPE_INVENTORY_TEXT) {
                com.center = dat.gbool();
                com.font = dat.g1();
                com.shadowed = dat.gbool();
                com.colour = dat.g4s();
            ...
            if (com.buttonType === Component.TARGET_BUTTON || com.comType === Component.TYPE_INVENTORY) {
