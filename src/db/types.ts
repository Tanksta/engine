...
export type beta_hiscore_large = {
    account_id: number;
    profile: Generated<string>;
    type: number;
    level: number;
...
export type npc_killcount = {
    account_id: number;
    profile: Generated<string>;
    npc_type: number;
    npc_name: string;
    kills: Generated<number>;
    last_kill: Generated<Timestamp>;
};
export type pet_acquisition = {
    id: Generated<number>;
    account_id: number;
    profile: Generated<string>;
    pet_item: number;
...
export type DB = {
    ...
    beta_hiscore: beta_hiscore;
    beta_hiscore_large: beta_hiscore_large;
    ...
    ipban: ipban;
    npc_killcount: npc_killcount;
    pet_acquisition: pet_acquisition;
