export const enum ScriptOpcode {
    ...
    REGION_FINDBYUID,
    REGION_SETEXITCOORD,
    TZHAAR_FIGHTCAVE_ACTIVE,
    TZHAAR_FIGHTCAVE_START_STATE,
    TZHAAR_FIGHTCAVE_JUMP_STATE,
    TZHAAR_FIGHTCAVE_RESET_STATE,
    TZHAAR_FIGHTCAVE_CLEAR_PROGRESS_STATE,
    TZHAAR_FIGHTCAVE_WAVE,
    TZHAAR_FIGHTCAVE_SET_WAVE,
    TZHAAR_FIGHTCAVE_REMAINING,
    TZHAAR_FIGHTCAVE_SET_REMAINING,
    TZHAAR_FIGHTCAVE_ROTATION,
    TZHAAR_FIGHTCAVE_SET_ROTATION,
    TZHAAR_FIGHTCAVE_HEALERS,
    TZHAAR_FIGHTCAVE_SET_HEALERS,
    TZHAAR_FIGHTCAVE_JAD_UID,
    TZHAAR_FIGHTCAVE_SET_JAD_UID,
    TZHAAR_FIGHTCAVE_JAD_SPAWN_COORD,
    TZHAAR_FIGHTCAVE_SET_JAD_SPAWN_COORD,
    TZHAAR_FIGHTCAVE_COMPLETED,
    TZHAAR_FIGHTCAVE_SET_COMPLETED,
    TZHAAR_FIGHTCAVE_RETURN_PENDING,
    TZHAAR_FIGHTCAVE_SET_RETURN_PENDING,
    ECTOFUNTUS_UNCLAIMED_TOKENS,
    ECTOFUNTUS_ADD_UNCLAIMED_TOKENS,
    ECTOFUNTUS_CLEAR_UNCLAIMED_TOKENS,
    ECTOFUNTUS_PENDING_BONEMEAL,
    ECTOFUNTUS_SET_PENDING_BONEMEAL,
    ...
    SETIDKCOLOUR = 2495,
    TELEBLOCK_SET = 2496,
    TELEBLOCK_TICKS = 2497,
    P_TRANSMOGRIFY = 2498,
    AFK_EVENT_SKILL = 2499,
...
export const ScriptOpcodeMap: Map<string, number> = new Map([
    ...
    ['TZHAAR_FIGHTCAVE_ACTIVE', ScriptOpcode.TZHAAR_FIGHTCAVE_ACTIVE],
    ['TZHAAR_FIGHTCAVE_START_STATE', ScriptOpcode.TZHAAR_FIGHTCAVE_START_STATE],
    ['TZHAAR_FIGHTCAVE_JUMP_STATE', ScriptOpcode.TZHAAR_FIGHTCAVE_JUMP_STATE],
    ['TZHAAR_FIGHTCAVE_RESET_STATE', ScriptOpcode.TZHAAR_FIGHTCAVE_RESET_STATE],
    ['TZHAAR_FIGHTCAVE_CLEAR_PROGRESS_STATE', ScriptOpcode.TZHAAR_FIGHTCAVE_CLEAR_PROGRESS_STATE],
    ['TZHAAR_FIGHTCAVE_WAVE', ScriptOpcode.TZHAAR_FIGHTCAVE_WAVE],
    ['TZHAAR_FIGHTCAVE_SET_WAVE', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_WAVE],
    ['TZHAAR_FIGHTCAVE_REMAINING', ScriptOpcode.TZHAAR_FIGHTCAVE_REMAINING],
    ['TZHAAR_FIGHTCAVE_SET_REMAINING', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_REMAINING],
    ['TZHAAR_FIGHTCAVE_ROTATION', ScriptOpcode.TZHAAR_FIGHTCAVE_ROTATION],
    ['TZHAAR_FIGHTCAVE_SET_ROTATION', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_ROTATION],
    ['TZHAAR_FIGHTCAVE_HEALERS', ScriptOpcode.TZHAAR_FIGHTCAVE_HEALERS],
    ['TZHAAR_FIGHTCAVE_SET_HEALERS', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_HEALERS],
    ['TZHAAR_FIGHTCAVE_JAD_UID', ScriptOpcode.TZHAAR_FIGHTCAVE_JAD_UID],
    ['TZHAAR_FIGHTCAVE_SET_JAD_UID', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_JAD_UID],
    ['TZHAAR_FIGHTCAVE_JAD_SPAWN_COORD', ScriptOpcode.TZHAAR_FIGHTCAVE_JAD_SPAWN_COORD],
    ['TZHAAR_FIGHTCAVE_SET_JAD_SPAWN_COORD', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_JAD_SPAWN_COORD],
    ['TZHAAR_FIGHTCAVE_COMPLETED', ScriptOpcode.TZHAAR_FIGHTCAVE_COMPLETED],
    ['TZHAAR_FIGHTCAVE_SET_COMPLETED', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_COMPLETED],
    ['TZHAAR_FIGHTCAVE_RETURN_PENDING', ScriptOpcode.TZHAAR_FIGHTCAVE_RETURN_PENDING],
    ['TZHAAR_FIGHTCAVE_SET_RETURN_PENDING', ScriptOpcode.TZHAAR_FIGHTCAVE_SET_RETURN_PENDING],
    ['ECTOFUNTUS_UNCLAIMED_TOKENS', ScriptOpcode.ECTOFUNTUS_UNCLAIMED_TOKENS],
    ['ECTOFUNTUS_ADD_UNCLAIMED_TOKENS', ScriptOpcode.ECTOFUNTUS_ADD_UNCLAIMED_TOKENS],
    ['ECTOFUNTUS_CLEAR_UNCLAIMED_TOKENS', ScriptOpcode.ECTOFUNTUS_CLEAR_UNCLAIMED_TOKENS],
    ['ECTOFUNTUS_PENDING_BONEMEAL', ScriptOpcode.ECTOFUNTUS_PENDING_BONEMEAL],
    ['ECTOFUNTUS_SET_PENDING_BONEMEAL', ScriptOpcode.ECTOFUNTUS_SET_PENDING_BONEMEAL],

    ['AFK_EVENT', ScriptOpcode.AFK_EVENT],
    ['AFK_EVENT_SKILL', ScriptOpcode.AFK_EVENT_SKILL],
    ['ALLOWDESIGN', ScriptOpcode.ALLOWDESIGN],
    ['ANIM', ScriptOpcode.ANIM],
    ['APPEARANCE_CLEARSLOT', ScriptOpcode.APPEARANCE_CLEARSLOT],
    ['APPEARANCE_SETSLOT', ScriptOpcode.APPEARANCE_SETSLOT],
    ...
    ['IDLELOGOUT_DISABLE', ScriptOpcode.IDLELOGOUT_DISABLE],
    ...
    ['P_FLYWALK', ScriptOpcode.P_FLYWALK],
    ['P_LOCADD', ScriptOpcode.P_LOCADD],
    ['P_LOCDEL', ScriptOpcode.P_LOCDEL],
    ['P_LOCRESET', ScriptOpcode.P_LOCRESET],
    ...
    ['P_TELEJUMP_INSTANCE', ScriptOpcode.P_TELEJUMP_INSTANCE],
    ...
    ['STAT_REDUCE', ScriptOpcode.STAT_REDUCE],
    ...
    ['NPC_KILLCOUNT', ScriptOpcode.NPC_KILLCOUNT],
    ['PET_ACQUIRED', ScriptOpcode.PET_ACQUIRED],
    ['STAT_SETLEVEL', ScriptOpcode.STAT_SETLEVEL],
    ['STAT_EXPERIENCE', ScriptOpcode.STAT_EXPERIENCE],
    ['STAT_RESTORE_EXACT', ScriptOpcode.STAT_RESTORE_EXACT],
    ['TELEBLOCK_SET', ScriptOpcode.TELEBLOCK_SET],
    ['TELEBLOCK_TICKS', ScriptOpcode.TELEBLOCK_TICKS],
    ...
    ['INV_DROPPERCENTAGE', ScriptOpcode.INV_DROPPERCENTAGE],
    ...
    ['MINRANDOMINC', ScriptOpcode.MINRANDOMINC],
