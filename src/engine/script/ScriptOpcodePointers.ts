...
const ScriptOpcodePointers: {
    ...
    [ScriptOpcode.APPEARANCE_CLEARSLOT]: {
        require: ['active_player']
    },
    [ScriptOpcode.APPEARANCE_SETSLOT]: {
        require: ['active_player']
    },
    ...
    [ScriptOpcode.IF_SETMODELOFFSET]: {
        require: ['active_player']
    },
    ...
    [ScriptOpcode.P_LOCADD]: {
        require: ['active_player']
    },
    [ScriptOpcode.P_LOCDEL]: {
        require: ['active_player']
    },
    [ScriptOpcode.P_LOCRESET]: {
        require: ['active_player']
    },
    ...
    [ScriptOpcode.P_TELEJUMP_INSTANCE]: {
        require: ['p_active_player'],
        require2: ['p_active_player2']
    },
    ...
    [ScriptOpcode.NPC_KILLCOUNT]: {
        require: ['active_player']
    },
    [ScriptOpcode.PET_ACQUIRED]: {
        require: ['active_player']
    },
    [ScriptOpcode.STAT_SETLEVEL]: {
        require: ['active_player']
    },
    [ScriptOpcode.STAT_EXPERIENCE]: {
        require: ['active_player']
    },
    [ScriptOpcode.STAT_RESTORE_EXACT]: {
        require: ['active_player']
    },
    [ScriptOpcode.TELEBLOCK_SET]: {
        require: ['active_player'],
        require2: ['active_player2']
    },
    [ScriptOpcode.TELEBLOCK_TICKS]: {
        require: ['active_player'],
        require2: ['active_player2']
    },
