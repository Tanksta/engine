...
import IfSetModelOffsetEncoder from '#/network/game/server/codec/IfSetModelOffsetEncoder.js';
...
import PStringDialogEncoder from '#/network/game/server/codec/PStringDialogEncoder.js';
...
class ServerGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(IfSetModelOffset, new IfSetModelOffsetEncoder());
        ...
        this.bind(PStringDialog, new PStringDialogEncoder());
