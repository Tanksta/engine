...
export default {
    ...
    /// web server
    WEB_PORT: tryParseInt(process.env.WEB_PORT, 81),
    WEB_ALLOWED_ORIGIN: tryParseString(process.env.WEB_ALLOWED_ORIGIN, ''),
    WEB_TRUST_PROXY: tryParseBoolean(process.env.WEB_TRUST_PROXY, false),

    // management server
    WEB_MANAGEMENT_PORT: tryParseInt(process.env.WEB_MANAGEMENT_PORT, 8899),
    DISCORD_CLIENT_ID: tryParseString(process.env.DISCORD_CLIENT_ID, ''),
    DISCORD_CLIENT_SECRET: tryParseString(process.env.DISCORD_CLIENT_SECRET, ''),
    DISCORD_REDIRECT_URI: tryParseString(process.env.DISCORD_REDIRECT_URI, ''),

    /// game server
    ENGINE_REVISION: tryParseInt(process.env.ENGINE_REVISION, 349),
    ...
    NODE_STAFF: tryParseString(process.env.NODE_STAFF, ''),
    ...
    LOGIN_PORT: tryParseInt(process.env.LOGIN_PORT, 43502),
    ...
    FRIEND_PORT: tryParseInt(process.env.FRIEND_PORT, 45100),
    ...
    LOGGER_PORT: tryParseInt(process.env.LOGGER_PORT, 43503),
